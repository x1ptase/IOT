...
\usepackage{graphicx} % Đã có sẵn, cần thiết cho \includegraphics
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{booktabs}
\usepackage{url}
...
\date{\textit{SU25\_IOT102\_IA1904}} % Mã môn học/Ngày
...
\begin{document}
	...
	\begin{figure}[htbp]
		\centering
		% ĐÃ CHÈN HÌNH block_diagram.png TẠI ĐÂY
	...
	\begin{figure}[htbp]
		\centering
		% ĐÃ CHÈN HÌNH flowchart.png TẠI ĐÂY
